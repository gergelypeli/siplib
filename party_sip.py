...
class SipEndpoint(Endpoint, InviteHelper, UpdateHelper, SessionHelper):
    ...
    def try_update(self, sdp, is_answer):
    ...
    def do(self, action):
        ...
        if self.state in (self.DOWN,):
            ...
            if type == "hangup":
                ...
                used_update = self.try_update(sdp, is_answer)
                if used_update:
                    return
            ...
            if session:
                if self.try_update(sdp, is_answer):
